...
updaterc 'eval "$(/home/linuxbrew/.linuxbrew/bin/brew shellenv)"'
updatefishconfig 'eval (/home/linuxbrew/.linuxbrew/bin/brew shellenv)'
eval "$(${BREW_PREFIX}/Homebrew/bin/brew shellenv)"

# symlink brew to /usr/local/bin
ln -s "${BREW_PREFIX}/Homebrew/bin/brew" /usr/local/bin/brew
ln -s "${BREW_PREFIX}/Homebrew/bin/brew" /bin/brew
